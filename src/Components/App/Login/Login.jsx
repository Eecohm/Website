...
const LoginForm = () => {
  ...
  if (isCheckingSavedLogin) return <div className={styles.loadingScreen}>Checking saved login...</div>;
      ...
      {showForgotModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modalBox}>
            ...
            {resetStep === 2 && (
              <>
                <input type="text" placeholder="Enter OTP" value={otp} onChange={(e) => setOtp(e.target.value)} className={styles.neonInput} />
                <input type="password" placeholder="New Password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className={styles.neonInput} />
                <input type="password" placeholder="Confirm Password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className={styles.neonInput} />
                <button className={styles.neonButton} onClick={handleVerifyOtpAndSetPassword}>Submit</button>
              </>
            )}
