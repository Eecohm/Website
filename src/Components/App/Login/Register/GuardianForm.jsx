...
const GuardianForm = () => {
      ...
      const fetchStudents = async () => {
        try {
          const response = await fetch(
            `${baseUrl}/user/students/?grade_id=${formData.grade}`,
            {
              method: "GET",
              headers: {
                Authorization: `Bearer ${token}`,
          ...
          setErrors((prev) => ({
            ...prev,
            student_id: "Failed to load students.",
          }));
        }
      };
      fetchStudents();
  ...
  const handleSubmit = async (e) => {
    ...
    newErrors.relation_to_student = validateName(
    ...
    for (const key in formData) {
      if (formData[key] && key !== "student_name") {
        ...
        <div className={styles.formGrid}>
          ...
          <div className={styles.autocompleteContainer}>
            ...
            <input
              ...
              aria-describedby={
                errors.student_id ? "student_id-error" : undefined
              }
            ...
            {errors.student_id && (
              <p id="student_id-error" className={styles.error}>
                {errors.student_id}
              </p>
            )}
          </div>
          <div>
            <label htmlFor="relation_to_student">
              Relation to Student <span className={styles.required}>*</span>
            </label>
            <input
              ...
              onChange={(e) => {
                ...
                setFormData((prev) => ({
                  ...prev,
                  relation_to_student: value,
                }));
                setErrors((prev) => ({
                  ...prev,
                  relation_to_student: validateName(
                    value,
                    "relation_to_student"
                  ),
                }));
              ...
              aria-describedby={
                errors.relation_to_student
                  ? "relation_to_student-error"
                  : undefined
              }
              required
            />
            {errors.relation_to_student && (
              <p id="relation_to_student-error" className={styles.error}>
                {errors.relation_to_student}
              </p>
            )}
          </div>
