...
const OwnerForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    newErrors.institution_name = validateTextField(
    ...
    <form className={styles.formContainer} onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setErrors((prev) => ({
                  ...prev,
                  institution_name: validateTextField(
                    value,
                    "institution_name"
                  ),
                }));
              ...
              aria-describedby={
                errors.institution_name ? "institution_name-error" : undefined
              }
              required
            />
            {errors.institution_name && (
              <p id="institution_name-error" className={styles.error}>
                {errors.institution_name}
              </p>
            )}
          </div>
      ...
      <div className={styles.buttonGroup}>
        ...
        <button
          ...
          type="button"
          onClick={() => {
            setCancelMessage("Registration cancelled. Redirecting to login...");
