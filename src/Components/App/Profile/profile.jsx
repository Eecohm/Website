...
import styles from "@/Components/App/Profile/Profile.module.css";
      ...
      <div className={styles.profileContainer}>
        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.cardsContainer}>
            <div
              className={`${styles.profileCard} ${styles.organizationCard}`}
            ...
            >
              ...
              <div className={styles.cardContent}>
                <h2>Organization</h2>
                <p>
                  Manage your organization details, settings, and configurations
                </p>
            ...
            <div
              className={`${styles.profileCard} ${styles.subOrgCard}`}
            ...
            >
              ...
              <div className={styles.cardContent}>
                ...
                <p>
                  Create and manage your sub-organizations, teams, and
                  departments
                </p>
                <div className={styles.cardStatus}>
                  <span className={`${styles.statusBadge} ${styles.neutral}`}>
                    Manage
                  </span>
                </div>
              </div>
          ...
          <div className={styles.infoSection}>
            <div className={styles.infoCard}>
              ...
              <div>
                <h3>Quick Setup</h3>
                <p>
                  Get started by setting up your organization profile first,
                  then create sub-organizations as needed.
                </p>
              </div>
            </div>
          </div>
