...
import detailListStyles from "@/Components/App/User/InfoModels/Details/Pages/OwnerDetail/components/DetailsListShared.module.css";

export const OwnerContactSection = ({ owner }) => (
