  ...
  return (
    <section className={styles.meetTheTeamLeads} ref={sectionRef}>
      ...
      <div className={styles.teamLeadsContainer}>
        <div className={styles.teamLeadsSlideshow}>
      ...
      <div className={`${styles.bgShape} ${styles.shapeDot}`} style={{ top: '15%', left: '20%' }}></div>
      <div className={`${styles.bgShape} ${styles.shapeStar}`} style={{ top: '25%', left: '70%' }}></div>
      <div className={`${styles.bgShape} ${styles.shapeDot}`} style={{ top: '50%', left: '10%' }}></div>
      <div className={`${styles.bgShape} ${styles.shapeStar}`} style={{ top: '70%', left: '40%' }}></div>
      <div className={`${styles.bgShape} ${styles.shapeDot}`} style={{ top: '80%', left: '80%' }}></div>
    </section>
  );
}
