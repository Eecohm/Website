...
export const courses = [
  ...
  },
  {
    ...
    description:
      "This specialized program helps students enhance their career prospects in the dynamic industry of hospitality with internationally recognized credentials.",
    photo: program_2,
    duration: "2 years",
    keyFeatures: [
  ...
  },
  {
    ...
    description:
      "This course introduces students to the hospitality industry with a focus on practical skills.",
    photo: hmimgs,
    duration: "2 years",
    keyFeatures: [
  ...
  },
  {
    ...
    description:
      "This program blends computer science with business education for a comprehensive learning experience.",
    photo: css,
    duration: "2 years",
    keyFeatures: [
  ...
  },
  {
    ...
    description:
      "This program offers a complete educational journey from pre-school to secondary levels.",
    photo: preschool,
    duration: "10 years",
    keyFeatures: [
