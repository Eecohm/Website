  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p><strong>Application</strong> refers to Eecohm School of Excellence, the software program provided by the Company.</p>
        </li>
        <li>
          <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Eecohm School of Excellence, Birtamod-1, Jhapa Nepal.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to eecohm, accessible from{' '}
      ...
      <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the{' '}
      ...
      <ul>
        <li><p>By email: eecohm@gmail.com</p></li>
        <li><p>By visiting this page on our website:{' '}
          <a href="https://eecohm@gmail.com" rel="external nofollow noopener" target="_blank">
            https://eecohm@gmail.com
          </a>
        </p></li>
        <li><p>By phone number: +977 985-2646392</p></li>
      </ul>
    </div>
  );
};
