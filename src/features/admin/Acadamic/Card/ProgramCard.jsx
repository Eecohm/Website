...
import styles from "@/features/admin/Acadamic/Card/ProgramCard.module.css";
import ModalNotification from "@/components/common/ModalNotification";
import NavBar from "@/features/admin/NavBar/NavBar";
import ProgramModalData from "@/features/admin/Acadamic/modal/ProgramModalData";
import {
  FiAlertCircle,
  FiSearch,
  FiPlus,
          ...
          <div className={styles.wholeDiv}>
            ...
            <div className={styles.leftPanel}>
                ...
                <div className={styles.programList}>
                  {programs.length ? (
                    programs.slice(0, 4).map((program) => (
                      <div
                        key={program.id}
                        className={`${styles.programItem} ${selectedProgram?.id === program.id ? styles.active : ""
                          }`}
              ...
              <div className={styles.addButtonContainer}>
                <button
                  className={`${styles.addBtn} ${!programs.length ? styles.highlightBtn : ""
                    }`}
                    ...
                    <div className={styles.formGrid}>
                      <div className={styles.fieldGroup}>
                        ...
                        <input
                          ...
                          className={`${styles.inputField} ${errors.programName ? styles.inputError : ""
                            }`}
                        />
                        {errors.programName && (
                      ...
                      <div className={styles.fieldGroup}>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          className={`${styles.inputField} ${errors.durationMonths ? styles.inputError : ""
                            }`}
                        />
                      ...
                      <div className={styles.fieldGroup}>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          className={`${styles.inputField} ${errors.affiliatedTo ? styles.inputError : ""
                            }`}
                        />
                        {errors.affiliatedTo && (
                          <div className={styles.error}>
