...
import VerificationWarningModal from "@/components/common/VerificationWarningModal";
...
const DashBoard = () => {
  ...
  const handleKycStatus = async (role, kyc_status, user_id) => {
    ...
    switch (effectiveStatus) {
      case "unverified":
        // User requested detailed simplified message
        message = "Your details are not verified yet. Please complete the verification form to proceed.";
        break;
      case "pending":
        message =
