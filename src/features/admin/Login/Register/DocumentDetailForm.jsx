      ...
      <div className={styles.formGrid}>
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, nagarikta_no: e.target.value })
            }
            required
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            required
          />
          {errors.nagarikta_photo && (
            <p className={styles.error}>{errors.nagarikta_photo}</p>
          )}
        </div>
        <div>
          ...
          />
          {errors.pan_photo && (
            <p className={styles.error}>{errors.pan_photo}</p>
          )}
        </div>
      </div>
    </div>
