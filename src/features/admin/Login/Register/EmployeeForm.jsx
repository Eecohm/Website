          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setErrors((prev) => ({
                  ...prev,
                  position: validateTextField(value, "position"),
                }));
              }}
              onBlur={(e) =>
                setErrors((prev) => ({
                  ...prev,
                  position: validateTextField(e.target.value, "position"),
                }))
              }
            ...
            />
            {errors.position && (
              <p id="position-error" className={styles.error}>
                {errors.position}
              </p>
            )}
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setErrors((prev) => ({
                  ...prev,
                  department: validateTextField(value, "department"),
                }));
              }}
              onBlur={(e) =>
                setErrors((prev) => ({
                  ...prev,
                  department: validateTextField(e.target.value, "department"),
                }))
              }
            ...
            />
            {errors.department && (
              <p id="department-error" className={styles.error}>
                {errors.department}
              </p>
            )}
          </div>
            ...
            <input
              ...
              aria-describedby={
                errors.driving_license_photo
                  ? "driving_license_photo-error"
                  : undefined
              }
            />
            {errors.driving_license_photo && (
              <p id="driving_license_photo-error" className={styles.error}>
                {errors.driving_license_photo}
              </p>
            )}
          </div>
