...
const PersonalDetailForm = ({
    ...
    return new Promise((resolve, reject) => {
      ...
      img.onload = () => {
        ...
        if (
          ...
          reject(
            `Photo must be a passport-sized image (approx. ${minWidth}-${maxWidth}px width, ${minHeight}-${maxHeight}px height).`
          );
        } else if (
  ...
  const handleChange = (e, field) => {
    ...
    if (field === "full_name") {
      ...
      setErrors((prev) => ({
        ...prev,
        [field]: value ? "" : `${field.replace("_", " ")} is required.`,
      }));
    }
  };
    ...
    <div className={styles.formSection}>
      ...
      <div className={styles.formGrid}>
        <div>
          ...
          />
          {errors.full_name && (
            <p id="full_name-error" className={styles.error}>
              {errors.full_name}
            </p>
          )}
        </div>
        <div>
          ...
          {errors.date_of_birth && (
            <p id="date_of_birth-error" className={styles.error}>
              {errors.date_of_birth}
            </p>
          )}
        </div>
        <div>
          ...
          {errors.gender && (
            <p id="gender-error" className={styles.error}>
              {errors.gender}
            </p>
          )}
        </div>
        <div>
          <label htmlFor="photo">
            Passport Size Photo <span className={styles.required}>*</span>
          </label>
          <input
            id="photo"
            type="file"
          ...
          />
          {errors.photo && (
            <p id="photo-error" className={styles.error}>
              {errors.photo}
            </p>
          )}
        </div>
