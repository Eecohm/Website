...
import TeamHeader from "@/features/landing/School/Team/TeamHeader";
import TeamMember from "@/features/landing/School/Team/TeamMember";
import styles from "@/features/landing/School/Team/MeetTheTeam.module.css";
...
const teamMembers = [
  ...
  },
  {
    ...
    quote:
      "A strategic Finance Executive ensuring financial stability and growth.",
    image: sumans,
    social: {
  ...
  },
  {
    ...
    quote:
      "“Empowering young minds driven for the stars, driven by passion and purpose.”",
    image: primila,
    social: {
...
function MeetTheTeam() {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e) => {
      ...
      const maxScroll =
        teamMembersContainer.scrollWidth - teamMembersContainer.clientWidth;
    ...
    if (teamMembersContainer) {
      teamMembersContainer.addEventListener("wheel", handleWheel, {
        passive: false,
      });
    }
