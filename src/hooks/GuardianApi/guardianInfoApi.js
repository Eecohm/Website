...
export const submitGuardianInfo = async (
  formData, //toSend
  baseUrl,
  login,
  setToken,
...
// if (["PUT", "PATCH"].includes(method.toUpperCase())) {
//This line checks if the HTTP method specified for the request is either "PUT" or "PATCH". It converts the method to uppercase to ensure the comparison is case-insensitive. If the method is one of these two, it indicates that the operation is intended to update an existing resource (as opposed to creating a new one, which would typically use "POST").
